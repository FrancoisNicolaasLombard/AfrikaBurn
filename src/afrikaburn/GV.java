...
public class GV {
    ...
    public static final double ZOOM_AMOUNT = 1.15; // Zoom amount of map
    public static final double METER_SQUARED_2_MAP_RATIO = 7.198666276306972e-2; // Got this value after comparing areas with GeoJSON
